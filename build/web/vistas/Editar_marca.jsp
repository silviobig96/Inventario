...
<html>
    <head>
        ...
        <title>Actualizacion de Marca</title>
        <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
        <link rel="stylesheet" href="vistas/css/bootstrap.min.css">
        <link rel="stylesheet" href="vistas/css/estilos_editar_marca.css">
    </head>
    <body>
       <%@include file="menuser.jsp" %>
	<div class="jumbotron">
            <div class="conatiner">
                <h1 style="color:  white">Actualizacion de Marca</h1>
                <p class="lead">Esta opcion del sistema le permite Actualizar los datos de una Marca.</p>
            </div>		
	</div>
        ...
        %>
            <h3 class="card-header" align = "center" >Actualizacion de Marca</h3>
