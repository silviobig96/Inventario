<%-- 
    Document   : EditarVaca
    Created on : 06/02/2019, 10:07:02 AM
            ...
            <form action="Controlador_Animal" method="post">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            placeholder="Nombre de la Nueva Vaca">
                        </div>    
                        <div class="col-md-1">
                            <label for="precio">Modelo:</label>
                        </div>
                        <div class="col-md-4">
                            <input type="text" required class="form-control" name="precio" id="precio" value="<%= animal.getPrecio() %>" aria-describedby="emailHelp" placeholder="Precio de Venta" >
                        </div>
                        <div class="col-md-1">
                ...
                <div class="row">
                    <div class="centrar">
                        ...
                        <a href="Controlador_Animal?accion=listar"> <button type="button" class="btn btn-primary"  >Volver</button><a/>
                    </div>
                </div>
            </form>
