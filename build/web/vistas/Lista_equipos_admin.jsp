...
<body>
	...
	<h3 class="card-header"  align = "center" >Listado de Equipos</h3>
        <br>
        <a style=" margin-left: 16px" class="btn btn-success" href="Controlador_Equipos?accion=registrar_admin">Registrar</a>
		 ...
		 %>
            ...
            <tr class="table-primary" align="center">
                ...
                <td style=" padding-left: 2px; padding-right: 2px;"> 
                    <a class="btn btn-primary" title="editar" href="Controlador_Equipos?accion=editar_admin&id=<%= animal.getId_animal()%>"><img src="vistas/Imagenes/editar.png" alt="x" /> </a>
